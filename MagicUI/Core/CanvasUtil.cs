...
namespace MagicUI.Core
{
    ...
    public static class CanvasUtil
    {
        ...
        public static Sprite CreateSpriteFromFile(string file, int? width = null, int? height = null)
        {
            try
            {
                ...
                tex.anisoLevel = 0;
                return Sprite.Create(tex, new Rect(0, 0, width.HasValue ? width.Value : tex.width, height.HasValue ? height.Value : tex.height), Vector2.zero);
            }
            catch (Exception e)
            {
        ...
        public static GameObject CreateButton(GameObject parent, Action<int> action, int id, Sprite spr, string text,
            int fontSize, TextAnchor textAnchor, RectData rectData, Font font, params Sprite[] extraSprites)
        {
            GameObject panel = CreateBasePanel(parent, rectData);
        ...
        public class RectData(Vector2 sizeDelta, Vector2 anchorPosition, Vector2 min, Vector2 max, Vector2 pivot)
        {
            /// <summary>
            ///     Describes on of the X,Y Positions of the Element
            /// </summary>
            public Vector2 AnchorMax = max;

            /// <summary>
            ///     Describes on of the X,Y Positions of the Element
            /// </summary>
            public Vector2 AnchorMin = min;

            /// <summary>
            /// </summary>
            public Vector2 AnchorPivot = pivot;
            ...
            /// </summary>
            public Vector2 RectSizeDelta = sizeDelta;
